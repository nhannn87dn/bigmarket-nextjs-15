...
export default function Alert({
    ...
    let typeClass = 'text-blue-600 bg-blue-100';
    if(type === 'error'){
        ...
        typeClass = 'text-orange-600 bg-orange-100'
    }

  return (
    <div className={`${className} flex items-center justify-between py-3 px-5 leading-normal ${typeClass} rounded`} role="alert">
        <p>{message}</p>
